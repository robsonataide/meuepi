...
public interface CompanyDAO extends JpaRepository<Company, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM ServiceProvided entity WHERE entity.company.id = :id")
  public Page<ServiceProvided> findServiceProvided(@Param(value="id") java.lang.String id,  Pageable pageable );
