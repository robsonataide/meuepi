...
public class CompanyREST {
  ...
  public HttpEntity<PagedResources<ServiceProvided>> findServiceProvided(@PathVariable("instanceId") java.lang.String instanceId, Pageable pageable, PagedResourcesAssembler assembler) {
    return new ResponseEntity<>(assembler.toResource(companyBusiness.findServiceProvided(instanceId,  pageable )), HttpStatus.OK);
  }
  ...
  public void deleteServiceProvided(@PathVariable("relationId") java.lang.String relationId) throws Exception {
    this.serviceProvidedBusiness.delete(relationId);
  }
  ...
  @RequestMapping(method = RequestMethod.PUT
  , value="/{instanceId}/ServiceProvided/{relationId}")
  public ServiceProvided putServiceProvided(@Validated @RequestBody final ServiceProvided entity, @PathVariable("relationId") java.lang.String relationId) throws Exception {
  return this.serviceProvidedBusiness.put(entity);
  }  
  ...
  @RequestMapping(method = RequestMethod.POST
  , value="/{instanceId}/ServiceProvided")
  public ServiceProvided postServiceProvided(@Validated @RequestBody final ServiceProvided entity, @PathVariable("instanceId") java.lang.String instanceId) throws Exception {
  Company company = this.companyBusiness.get(instanceId);
  entity.setCompany(company);
  return this.serviceProvidedBusiness.post(entity);
  }   
